    ...
    <div class="min-h-screen bg-gradient-to-b from-gray-900 to-gray-800 text-gray-100">
        <div class="container mx-auto px-4 py-8">
            ...
            <div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-8">
                ...
                <a href="{{ route('sekretaris.surat-keluar.create') }}"
            ...
            <div class="bg-gray-800/50 rounded-xl p-5 border border-gray-700/50 mb-8 shadow-lg">
                <form action="{{ route('sekretaris.surat-keluar.index') }}" method="GET">
                            ...
                            @forelse ($data as $item)
                                <tr class="hover:bg-gray-700/30 transition-colors duration-150 text-center text-sm">
                                    ...
                                    <td class="py-3 px-4 text-gray-300">
                                        {{ Carbon\Carbon::parse($item->tgl_dikirim)->format('d F Y') }}</td>
                                    <td class="py-3 px-4 text-gray-300">{{ $item->perihal }}</td>
                                    <td class="py-3 px-4 text-gray-300">{{ $item->keterangan }}</td>
                                    <td class="py-3 px-4">
                                    ...
                                    <td class="py-3 px-4">
                                        <div class="flex gap-2">
                                            <a href="{{ route('sekretaris.surat-keluar.edit', $item->no_surat) }}"
                                            ...
                                            <form action="{{ route('sekretaris.surat-keluar.destroy', $item->no_surat) }}"
                                                method="POST"
