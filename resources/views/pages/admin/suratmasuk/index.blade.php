                ...
                <div class="overflow-x-auto">
                    <table class="w-full">
                        ...
                        <tbody class="divide-y divide-gray-800/50">
                            ...
                            <tr class="hover:bg-gray-700/30 transition-colors duration-150 text-center">
                                <td class="py-3 px-4">
                                    1
                                </td>
                                <td class="py-3 px-4 text-gray-300">12321</td>
                                <td class="py-3 px-4 text-gray-200 font-medium">Surat Ajuan Kompensasi</td>
                                <td class="py-3 px-4">
                                ...
                                <td class="py-3 px-4 text-gray-300">10 Mei 2025</td>
                                <td class="py-3 px-4 text-gray-300">
                                    Buu
                                </td>
                                <td class="py-3 px-4">
                                    <img src="{{ asset('pkk.png') }}" alt="Logo PKK" class="w-14 h-14 object-contain "
                                        loading="lazy" />
                                </td>
                                <td class="py-3 px-4">
                                    <div class="flex gap-2">
                                        <a href="/show"
                                            class="p-2 bg-gray-700/50 hover:bg-gray-700 text-gray-300 hover:text-white rounded-lg transition-colors"
                                            title="View">
