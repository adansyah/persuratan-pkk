                ...
                <form action="" method="POST" enctype="multipart/form-data" class="p-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="space-y-6">
                            ...
                            <!-- Category -->
                            <div>
                                <label for="category_id" class="block text-sm font-medium text-gray-300 mb-1">Asal</label>
                                <input type="date" id="nama_surat" name="nama_surat" value="{{ old('nama_surat') }}"
                                    required
                                    class="w-full px-4 py-2.5 bg-gray-900/70 border border-gray-700/50 rounded-lg text-gray-100 focus:outline-none focus:ring-2 focus:ring-cyan-500/50 focus:border-transparent transition-all duration-200"
                                    placeholder="Masukan Nama Surat">
                                @error('nama_surat')
                            ...
                            <div class="grid grid-cols-2 gap-4">
                                <!-- Price -->
                                <div>
                                    <label for="price" class="block text-sm font-medium text-gray-300 mb-1">Tanggal Surat
                                        <span class="text-rose-400">*</span></label>
                                    <input type="date" id="price" name="price" value="{{ old('price') }}" required
                                        min="0" step="0.01"
                                ...
                                <!-- Discount -->
                                <div>
                                    <label for="discount" class="block text-sm font-medium text-gray-300 mb-1">Tanggal
                                        Surat Diterima</label>
                                    <input type="date" id="discount" name="discount" value="{{ old('discount') }}"
                                        min="0" max="100"
                        ...
                        <div class="space-y-6">
                            ...
                            <div>
                                <label for="description"
                                    class="block text-sm font-medium text-gray-300 mb-1">Perihal</label>
                            ...
                            <!-- Image Upload -->
                            <div>
                                <label for="image" class="block text-sm font-medium text-gray-300 mb-1">Upload File
                                    (Upload)</label>
                                <div
