    ...
    <div class="min-h-screen bg-gradient-to-b from-gray-900 to-gray-800 text-gray-100">
        <div class="container mx-auto px-4 py-8">
            ...
            <div class="bg-gray-800/50 rounded-xl p-5 border border-gray-700/50 mb-8 shadow-lg">
                <form action="{{ route('ketua.surat-keluar.index') }}" method="GET">
                    <div class="flex flex-col md:flex-row gap-4">
                        ...
                        <div class="flex gap-3">
                            ...
                            @if (request('search'))
                                <a href="{{ route('ketua.surat-keluar.index') }}"
                        ...
                        <tbody class="divide-y divide-gray-800/50">
                            @forelse ($data as $item)
                                <tr class="hover:bg-gray-700/30 transition-colors duration-150 text-center text-sm">
                                    ...
                                    <td class="py-3 px-4">
                                        <span
                                            class="px-2.5 py-1 bg-cyan-500/50 text-gray-300 rounded-full text-xs font-medium">
                                            {{ $item->user->role }}
                                        </span>
                                    </td>
